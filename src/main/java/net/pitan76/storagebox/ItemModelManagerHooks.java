...
public class ItemModelManagerHooks {
    ...
    public static boolean update(ItemModelManager itemModelManager, ItemRenderState renderState, ItemStack stack, ModelTransformationMode transformationMode, World world, LivingEntity entity, int seed) {
        ...
        try {
            itemModelManager.update(renderState, renderStack, transformationMode, world, entity, seed);
        } finally {
